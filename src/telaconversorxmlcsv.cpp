...
#include "ui_telaconversorxmlcsv.h"

telaConversorXmlCsv::telaConversorXmlCsv(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::telaConversorXmlCsv)
{
    ui->setupUi(this);
...
void telaConversorXmlCsv::on_pbCarregarXml_clicked()
{
    ...
    conversor.converteArquivo(fonteCaminhoArquivo);
...
void telaConversorXmlCsv::lerETOXML(QString nomeArquivo)
{
...
void telaConversorXmlCsv::lerTRKING(QString nomeArquivo)
{
...
void telaConversorXmlCsv::totalizacoesEtografia()
{
//encontra frequencia
...
void telaConversorXmlCsv::lerTimeXml(int qualLer)
{
...
void telaConversorXmlCsv::escreverTimeCsv()
{
...
void telaConversorXmlCsv::escreverSeqCsv()
{
...
//void telaConversorXmlCsv::lerKohoXml()
//{

//}

void telaConversorXmlCsv::escreverKohoCsv()
{
    outGravador.setFileName(nomeArquivoGravarCsv);
    outGravador.open(QIODevice::WriteOnly | QIODevice::Text );
...
//void telaConversorXmlCsv::lerFleissXml()
//{

//}

void telaConversorXmlCsv::escreverFleisCsv()
{
...
QString telaConversorXmlCsv::conPontoVirgula(double num)
{
...
void telaConversorXmlCsv::escreverEtografiaCsv()
{
    outGravador.setFileName(nomeArquivoGravarCsv);
    outGravador.open(QIODevice::WriteOnly | QIODevice::Text );
...
void telaConversorXmlCsv::escreverTrakinCsv()
{
