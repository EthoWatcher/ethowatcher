#ifndef TELACADASTROVIDEO_H
#define TELACADASTROVIDEO_H
...
namespace Ui {
class TelaCadastroVideo;
}

class TelaCadastroVideo : public QWidget
{
    Q_OBJECT

public:
    explicit TelaCadastroVideo(QWidget *parent = 0);
    ~TelaCadastroVideo();
    //calibracao *calibracaoVideo;
...
private slots:
   ...
   void on_pbSetNoiseArea_clicked();

private:
    Ui::TelaCadastroVideo *ui;
